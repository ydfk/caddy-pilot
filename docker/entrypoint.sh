...
: "${CADDYPILOT_HTTP_PORT:=80}"
: "${CADDYPILOT_HTTPS_PORT:=443}"
: "${CADDYPILOT_PASSKEY_RP_ID:=localhost}"
: "${CADDYPILOT_PASSKEY_RP_NAME:=CaddyPilot}"
: "${CADDYPILOT_PASSKEY_ORIGINS:=http://localhost:8080}"
: "${TZ:=Asia/Shanghai}"
...
export CADDYPILOT_HTTP_PORT CADDYPILOT_HTTPS_PORT
export CADDYPILOT_PASSKEY_RP_ID CADDYPILOT_PASSKEY_RP_NAME CADDYPILOT_PASSKEY_ORIGINS
